...
const BuildApps = () => {
  return (
    <div className="c-gqwkJN c-gqwkJN-fGHEql-fullWidth-true c-gqwkJN-iTKOFX-direction-column c-gqwkJN-jroWjL-align-center c-gqwkJN-bICGYT-justify-center c-gqwkJN-kVNAnR-wrap-noWrap">
      <div className="Usecases_section__idiY6" id="slider" style={{ 'padding-bottom': 0 }}>
        <a
          ...
          href="https://trush-foundation.gitbook.io/trush-network/use-cases/cross-chain-interoperability-with-trush" target="_blank"
        >
          <span>
        ...
        <div className="Usecases_headTitle__bkrB-">
          ...
          <div
            ...
            style={{ opacity: 1 }}
          >
            Trush: Uniting Blockchains <span className="jss170">Globally</span>
          </div>
      ...
      <div className="c-PJLV c-ccUAhX">
        ...
        <div className="c-gqwkJN c-gqwkJN-ejCoEP-direction-row c-gqwkJN-igtkwp-align-end c-gqwkJN-awKDG-justify-start c-gqwkJN-kVNAnR-wrap-noWrap c-csPmrL c-csPmrL-bOzIcj-variant-half">
          ...
          <div className="c-gqwkJN c-gqwkJN-iTKOFX-direction-column c-gqwkJN-JrrAq-align-start c-gqwkJN-awKDG-justify-start c-gqwkJN-kVNAnR-wrap-noWrap c-kKcGaR c-kKcGaR-eYmcvs-variant-half">
            ...
            <p className="c-khxPPA c-khxPPA-ifHAhc-css">
              TIP forms the backbone of Trush's interoperability, enabling secure and efficient data and transaction exchange across compatible blockchains. With TIP, Trush accelerates innovation by expanding functionalities available to developers.
            </p>
          </div>
        </div>
        <div className="c-gqwkJN c-gqwkJN-ejCoEP-direction-row c-gqwkJN-igtkwp-align-end c-gqwkJN-awKDG-justify-start c-gqwkJN-kVNAnR-wrap-noWrap c-csPmrL c-csPmrL-bOzIcj-variant-half">
          ...
          <div className="c-gqwkJN c-gqwkJN-iTKOFX-direction-column c-gqwkJN-JrrAq-align-start c-gqwkJN-awKDG-justify-start c-gqwkJN-kVNAnR-wrap-noWrap c-kKcGaR c-kKcGaR-eYmcvs-variant-half">
            ...
            <p className="c-khxPPA c-khxPPA-ifHAhc-css">
               Trush Universal Gateway (TUG) promotes a unified blockchain realm. As a cross-chain bridge, TUG ensures precise asset transfers across differing blockchains, enhancing liquidity, access, and innovation.
            </p>
          </div>
        </div>
      </div>
