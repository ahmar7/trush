      ...
      <section className="exchanges-wallets dapps-projects  MuiContainer-root-81 MuiContainer-maxWidthLg-87">
        <div className="wrapper">
          <div className="main-header__block">
            <h2 className="main__title">Web 3.0 projects build on Velas</h2>
            <p className="main__text">
              We already have a portfolio of forward-minded Web 3.0 solutions
              powered by Velas - take a look.
            </p>
            <a
