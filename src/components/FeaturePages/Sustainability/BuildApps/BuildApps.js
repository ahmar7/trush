...
import "./BuildApps.css";
const BuildApps = () => {
  return (
    <div className="c-gqwkJN c-gqwkJN-fGHEql-fullWidth-true c-gqwkJN-iTKOFX-direction-column c-gqwkJN-jroWjL-align-center c-gqwkJN-bICGYT-justify-center c-gqwkJN-kVNAnR-wrap-noWrap">
      <div
        className="Usecases_section__idiY6"
        id="slider"
      ...
      >
        ...
        <div className="Usecases_headTitle__bkrB-">
          ...
          <div
            ...
            style={{ opacity: 1 }}
          >
            Leading the <span className="jss170">Eco-Blockchain Wave</span>
          </div>
          <div className="Usecases_line__88Mr- Usecases_lineFlip__FnBpH" />
        </div>
      </div>
      <div className="c-PJLV c-ccUAhX  tc-padeo">
        <div className="c-gqwkJN  c-gqwkJN-ejCoEP-direction-row c-gqwkJN-igtkwp-align-end c-gqwkJN-awKDG-justify-start c-gqwkJN-kVNAnR-wrap-noWrap c-csPmrL c-csPmrL-cSVyQl-variant-full">
          <div className="c-gqwkJN c-gqwkJN-iTKOFX-direction-column c-gqwkJN-JrrAq-align-start c-gqwkJN-awKDG-justify-start c-gqwkJN-kVNAnR-wrap-noWrap c-kKcGaR">
            ...
            <div className="c-gqwkJN c-gqwkJN-ejCoEP-direction-row c-gqwkJN-jroWjL-align-center c-gqwkJN-bICGYT-justify-center c-gqwkJN-kVNAnR-wrap-noWrap c-gqwkJN-fVlWzK-gap-3 c-gqwkJN-ejLhMq-mb-4">
              <div className="words-section_title__Pb56o jss170">
                Trush: Pioneering Blockchain Sustainability
              </div>
            </div>
            <p className="c-khxPPA c-khxPPA-ifHAhc-css">
              Trush pioneers eco-friendly blockchain, powered by green tech and a dedicated community. Join our sustainable mission.
            </p>
          </div>
          <div className="c-PJLV c-cQsYws c-cQsYws-cFMLhj-variant-full">
            <img
              ...
              sizes="100vw"
              src="https://www.enso.finance/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fenso-benefit-1.c49e787b.webp&w=3840&q=75"
              decoding="async"
              data-nimg="fill"
              loading="lazy"
              style={{
        ...
        <div className="c-gqwkJN c-gqwkJN-ejCoEP-direction-row c-gqwkJN-igtkwp-align-end c-gqwkJN-awKDG-justify-start c-gqwkJN-kVNAnR-wrap-noWrap c-csPmrL c-csPmrL-bOzIcj-variant-half">
          <div className="c-PJLV c-cQsYws c-cQsYws-cqGezO-variant-half">
            <img
              alt="Simplify complex interactions"
              src="https://www.enso.finance/_next/static/media/enso-benefit-2.9b7f5bd0.svg"
              decoding="async"
              data-nimg="fill"
              loading="lazy"
              style={{
          ...
          <div className="c-gqwkJN c-gqwkJN-iTKOFX-direction-column c-gqwkJN-JrrAq-align-start c-gqwkJN-awKDG-justify-start c-gqwkJN-kVNAnR-wrap-noWrap c-kKcGaR c-kKcGaR-eYmcvs-variant-half">
            ...
            <div className="c-gqwkJN c-gqwkJN-ejCoEP-direction-row c-gqwkJN-jroWjL-align-center c-gqwkJN-bICGYT-justify-center c-gqwkJN-kVNAnR-wrap-noWrap c-gqwkJN-fVlWzK-gap-3 c-gqwkJN-ejLhMq-mb-4">
              <div className="words-section_title__Pb56o jss170">
                Empowering Community-Led Green Efforts
              </div>
            </div>
            <p className="c-khxPPA c-khxPPA-ifHAhc-css">
              Trush's eco-push taps community strength with Green Ambassador Programs, forums & user-led projects. Our 'Blocks for Trees' offsets carbon, while TRS holders shape eco-policies. Together, we green blockchain.
            </p>
          </div>
        </div>
        <div className="c-gqwkJN c-gqwkJN-ejCoEP-direction-row c-gqwkJN-igtkwp-align-end c-gqwkJN-awKDG-justify-start c-gqwkJN-kVNAnR-wrap-noWrap c-csPmrL c-csPmrL-bOzIcj-variant-half">
          <div className="c-PJLV c-cQsYws c-cQsYws-jmiiOG-isLast-true c-cQsYws-cqGezO-variant-half">
            <img
              alt="Optimise costs at every step"
              src="https://www.enso.finance/_next/static/media/enso-benefit-3.06770505.svg"
              decoding="async"
              data-nimg="fill"
              loading="lazy"
              style={{
          ...
          <div className="c-gqwkJN c-gqwkJN-iTKOFX-direction-column c-gqwkJN-JrrAq-align-start c-gqwkJN-awKDG-justify-start c-gqwkJN-kVNAnR-wrap-noWrap c-kKcGaR c-kKcGaR-eYmcvs-variant-half">
            ...
            <p className="c-khxPPA c-khxPPA-ifHAhc-css">
              Trush actively crafts a greener tomorrow. Our Green Validator, efficient hardware studies, global carbon offsets, tree initiatives, and renewable ties all play a part. We back ocean clean-ups, solidifying our full eco-commitment.
            </p>
          </div>
        </div>
      </div>
