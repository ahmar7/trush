      ...
      <section className="exchanges-wallets dapps-projects  MuiContainer-root-81 MuiContainer-maxWidthLg-87">
        <div className="wrapper">
          <div className="main-header__block">
            <h2 className="main__title">DEXs support Velas</h2>
            <p className="main__text">
              DEX is the future of crypto exchange. See some of the major DEX
              projects built on Velas blockchain that are shaping this future
